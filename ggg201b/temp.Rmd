...
We define an R function to calculate allele frequencies for a bi-allelic locus given genotype frequencies. When provided genotype frequencies in the order (homozygous1, heterozygous, homozygous2), the function returns frequency of allele1, frequency of allele2, and 1-frequency of allele1 (added to double check calc. allele 2 frequency). I recycle this function for later questions in the assignment.
```{r}
################################################
# Allele Frequencies
################################################
...
We define a function to return the expected frequency of heterozygous genotypes as 2pq when allele frequencies are p and q.
```{r}
################################################
...
We use the definitive set of observed haplotypes to calculate allele frequencies. 
```{r}
################################################
...
# Problem 4  
## What is FST between SP01 and SP03 at locus 1?
```{r}
################################################
...
##  What is FST among all four subpopulations at locus 3
```{r}
...
# Problem 5
I wrote a python program to analyze the given sequence data. The program (also submitted) returns pairwise differences, s, pi, and the sequences reduced to segregating sites only. 
...
## What are s and ?? expressed in per site values?
```{r}
s <- 10
pi <- 4.4
nsite <- 50
